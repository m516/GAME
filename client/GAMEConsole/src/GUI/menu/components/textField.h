...
private:
	...
	*/
	...
	const char characters[sf::Keyboard::KeyCount] = {
		'A', // A = 0,        ///< The A key
		'B', // B,            ///< The B key
		'C', // C,            ///< The C key
		'D', // D,            ///< The D key
		...
		'8', // Num8,         ///< The 8 key
		'9', // Num9,         ///< The 9 key
		0  , // Escape,       ///< The Escape key
		0  , // LControl,     ///< The left Control key
		0  , // LShift,       ///< The left Shift key
		0  , // LAlt,         ///< The left Alt key
		0  , // LSystem,      ///< The left OS specific key: window (Windows and Linux), apple (MacOS X), ...
		0  , // RControl,     ///< The right Control key
		0  , // RShift,       ///< The right Shift key
		0  , // RAlt,         ///< The right Alt key
		0  , // RSystem,      ///< The right OS specific key: window (Windows and Linux), apple (MacOS X), ...
		0  , // Menu,         ///< The Menu key
		'[', // LBracket,     ///< The [ key
		']', // RBracket,     ///< The ] key
		';', // Semicolon,    ///< The ; key
		...
		' ', // Space,        ///< The Space key
		0  , // Enter,        ///< The Enter/Return keys
		0  , // Backspace,    ///< The Backspace key
		'\t',// Tab,          ///< The Tabulation key
		0  , // PageUp,       ///< The Page up key
		0  , // PageDown,     ///< The Page down key
		0  , // End,          ///< The End key
		0  , // Home,         ///< The Home key
		0  , // Insert,       ///< The Insert key
		0  , // Delete,       ///< The Delete key
		'+', // Add,          ///< The + key
		...
		0  , // Up,           ///< Up arrow
		0  , // Down,         ///< Down arrow
		'0', // Numpad0,      ///< The numpad 0 key
		'1', // Numpad1,      ///< The numpad 1 key
		'2', // Numpad2,      ///< The numpad 2 key
		'3', // Numpad3,      ///< The numpad 3 key
		'4', // Numpad4,      ///< The numpad 4 key
		'5', // Numpad5,      ///< The numpad 5 key
		'6', // Numpad6,      ///< The numpad 6 key
		'7', // Numpad7,      ///< The numpad 7 key
		'8', // Numpad8,      ///< The numpad 8 key
		'9', // Numpad9,      ///< The numpad 9 key
		0  , // F1,           ///< The F1 key
		0  , // F2,           ///< The F2 key
		0  , // F3,           ///< The F3 key
		0  , // F4,           ///< The F4 key
